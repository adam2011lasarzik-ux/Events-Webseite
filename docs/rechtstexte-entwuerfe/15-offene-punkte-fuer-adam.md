...
- **B-14** — ✅ **Vollständig erledigt am 21.09.2026** (Teil (b) am 21.09., Teil (a) im selben Zug nachgezogen) — kritisch geprüft, mit Adam abgestimmt, nicht einfach umgesetzt.
  ...
  - **Weiterhin ausdrücklich offen, nicht als bestätigt behandelt:** Ob die Veranstaltungsstätte selbst filmt oder ausschließlich die von VERA bereitgestellten Übersichtsaufnahmen weiterverwendet — siehe Dokument 16, Frage 5 (B-18). Filmt sie selbst, muss das separat dokumentiert und den Teilnehmenden vorher mitgeteilt werden; das ist noch nicht geschehen.
...
- **B-12** — ✅ **Erledigt am 21.09.2026, mit klarem Ergebnis statt eines Platzhalters:** **VERA Events besitzt aktuell keinen offiziellen Instagram-Kanal.** Das war bereits am 19.09.2026 belegt (Volltextsuche über `content/`, `components/`, `app/` nach Instagram/Facebook/TikTok/LinkedIn/YouTube ohne Treffer) und wird jetzt entsprechend dokumentiert, statt weiter als offene Angabe zu stehen.
  ...
  - **Was ausdrücklich unberührt bleibt:** der Instagram-Kanal der jeweiligen Veranstaltungsstätte. Ob sie einen hat, ist weiterhin ungeklärt (Dokument 16, Frage 5) — das wird hier nicht mitbehauptet, nur VERAs eigener Kanal ist jetzt geklärt.
