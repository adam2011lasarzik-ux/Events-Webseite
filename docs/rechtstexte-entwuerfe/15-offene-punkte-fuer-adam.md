...
| 1.5 | ✅ **Am 20.09.2026 von Adam bestätigt — bis auf die Stripe-Anschriften erledigt.** **Hostinger:** Hostinger International Ltd., 61 Lordou Vironos Street, 6023 Larnaca, Zypern (EU) — damit ist geklärt, dass **nicht** Hostinger Global S.à r.l. (Luxemburg) der Vertragspartner ist; dieselbe Gesellschaft gilt für Server **und** E-Mail. **Stripe:** Nach dem aktuellen Stripe-Datenverarbeitungsvertrag ist bei einem deutschen Konto **Stripe Payments Europe, Limited (SPEL)** für die Datenverarbeitung zuständig; der Stripe-Rahmenvertrag nennt zusätzlich **Stripe Technology Europe, Limited (STEL)** als mögliche weitere Vertragspartei für bestimmte Zahlungsdienste. Beide sitzen in **Irland** — aus der Gesellschaft selbst entsteht kein Drittlandbezug. **Backblaze, Inc.** (San Mateo, USA) und **UptimeRobot s. r. o.** (Bratislava) waren bereits eindeutig. ⚠️ **Offen bleibt genau eines: die beiden Stripe-Anschriften.** `stripe.com` und `support.stripe.com` sind aus der Arbeitsumgebung netzwerkseitig gesperrt (geprüft 20.09.2026, beide Abrufe vom Egress-Proxy abgewiesen) — die Anschriften lassen sich von hier aus **nicht aus einer Stripe-Primärquelle** übernehmen. Die frühere Angabe „One Wilton Park, Wilton Place, Dublin 2" stammte aus Sekundärrecherche und wurde deshalb **entfernt**, nicht übernommen. Abzulesen aus dem Stripe-Datenverarbeitungsvertrag bzw. der Stripe Services Agreement, Abschnitt „Definitionen". | Stripe-Rechtsdokumente (nur die Anschriften) |
...
- **B-3** — 🛑 **Neu gefasst 19.09.2026.** Das heutige Foto-Häkchen im Online-Formular (ohne Zweck, Kanal oder Dauer) wird **nicht** ausgebaut, sondern **ersetzt** — durch das verpflichtende Kenntnisnahme-Häkchen und den abgesetzten Widerspruchshinweis aus B-17. Der bisherige Auftrag „braucht einen ausführlicheren Text" ist damit gegenstandslos.
