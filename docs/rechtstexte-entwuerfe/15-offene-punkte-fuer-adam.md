...
- **B-20** — ⚠️ **Aus dem Konsistenzdurchlauf vom 20.09.2026 (Fund K-7): eine Regelungslücke, keine bloße Redaktion.** Abschnitt 2.4 der Stornoregeln (kostenlose Stornierung, solange kein Termin feststeht) wurde am 18.09.2026 gestrichen, Abschnitt 3.3 am 20.09.2026 — beide, weil seit Entscheidung 2.5 ohne feststehenden Termin nicht gebucht werden darf. **Die Software setzt das aber noch nicht durch** (B-5). Solange beides gilt, kann eine Buchung ohne Termin entstehen, für die es **keine passende Klausel mehr gibt**: die alte ist weg, die Sperre fehlt. **B-5 ist damit nicht mehr nur eine Komfortfrage, sondern vorrangig.**
